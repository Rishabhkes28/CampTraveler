  ...
  return (
    ...
    pb-32 md:gap-28 lg:py-20 xl:flex-row ">
      ...
      <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>
        We want to be on each of your journey seeking the satisfaction of seeing the incorruptible beauty of nature. We can help you on an adventure the world in just one app
      </p>
